...
kubectl exec -it "$(kubectl get pods -l app=nginx-external -o name)" -- /usr/sbin/nginx -s reload
kubectl exec -it "$(kubectl get pods -l app=nginx-external-other -o name)" -- /usr/sbin/nginx -s reload
