...
var (
	...
	nodeConfig = datapath.LocalNodeConfiguration{
		NodeIPv4:            netip.MustParseAddr(fakeNodeAddressing.IPv4().PrimaryExternal().String()),
		NodeIPv6:            netip.MustParseAddr(fakeNodeAddressing.IPv6().PrimaryExternal().String()),
